...
Public Class StudentCostsFile
    ...
    Sub New(ByVal StudentID As String, ByRef StudentName As String,
    ...
    Sub WriteRecord()
        ...
        Dim strNameandLocationofFile As String = "C:\CollegeRegistration\CollegeRegistration\StudentCosts.txt"
